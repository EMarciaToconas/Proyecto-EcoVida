...
app.config['SQLALCHEMY_DATABASE_URI']='mysql+pymysql://root:root@localhost/ecovida'
...
@app.route('/ecovida/<id>',methods=['GET'])
def get_producto(id):
    producto=Producto.query.get(id)
    return producto_schema.jsonify(producto) # retorna el JSON de un producto recibido como parametro

@app.route('/ecovida/<id>',methods=['DELETE'])
...
@app.route('/ecovida', methods=['POST']) # crea ruta o endpoint
def create_producto():
...
@app.route('/ecovida/<id>' ,methods=['PUT'])
